                    ...
                    <nav>
                        <div class="flex flex-wrap gap-2 sm:gap-4">
                            <button
                                ...
                                {{ $t("All") }}
                                <span class="text-red-500 font-bold">[{{ getCategoryCount("All") }}]</span>
                            </button>
                            ...
                            <button
                                ...
                                {{ $t("Quraan") }}
                                <span class="text-red-500 font-bold">[{{ getCategoryCount("Quraan") }}]</span>
                            </button>
                            ...
                            <button
                                ...
                                {{ $t("Tajweed")
                                }}<span class="text-red-500 font-bold">[{{ getCategoryCount("Tajweed") }}]</span>
                            </button>
                            ...
                            <button
                                ...
                                {{ $t("Arabic") }}
                                <span class="text-red-500 font-bold">[{{ getCategoryCount("Arabic") }}]</span>
                            </button>
                        </div>
                    </nav>
                </div>
            ...
            <div class="mb-8">
                <div class="flex flex-wrap -mx-4">
                    <div v-for="item in filteredCourses" :key="item.id" class="w-full sm:w-1/2 lg:w-1/3 px-4 mb-8">
                        <div
                            class="course-card bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                            <!-- Course Image -->
                            ...
                            <!-- Course Content -->
                            <div class="p-6 flex flex-col course-content">
                                <!-- Category Badge -->
                                <div class="mb-3">
                                    <span
                                ...
                                <div class="mb-4">
                                    <h5 class="text-sm font-medium text-gray-600 mb-2">
                                        {{ item.level }}
                                        <span class="text-green-600">{{ item.beginer }}</span>
                                    </h5>
