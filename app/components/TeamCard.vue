  ...
  <div class="team-card group">
    ...
    <div class="relative mb-6">
      ...
      <div class="relative rounded-[5px] overflow-hidden">
        <NuxtLink
          :to="detailsLink"
          class="block relative image-link"
          :aria-label="$t('teamArea.viewProfile', { name: $t(member.nameKey) })"
        >
          <img
            :src="member.image"
            :alt="$t(member.nameKey)"
            class="w-full rounded-[5px] transition-transform duration-300 group-hover:scale-105"
            loading="lazy"
          >
        </NuxtLink>
      </div>
      ...
      >
        ...
        >
          <a
            :href="social.url"
            :aria-label="`${$t(member.nameKey)} on ${social.platform}`"
            target="_blank"
    ...
    <div class="text-center">
      ...
      <span class="inline-block text-[var(--color-body)]">
